...
function CheckQuest() 
    ...
    game:GetService("Players").LocalPlayer.Idled:connect(function()
        ...
        wait(1)
        game:GetService("VirtualUser"):Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame)p
...
spawn(function()
    ...
    Main:Toggle("Delete Attack FIx(เปิดแล้วบัคตีไม่โดน)",nil,function(d)
    _G.DeleteAttackFx = d
